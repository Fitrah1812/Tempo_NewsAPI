...
class HomeViewModel: ObservableObject {
    ...
    func fetchNewsFood() async {
        ...
        Task {
            do {
                let url = URL(string: "https://berita-indo-api-next.vercel.app/api/zetizen-jawapos-news/food-and-traveling")!
                let (data, _) = try await URLSession.shared.data(from: url)
                let response = try JSONDecoder().decode(DataApi.self, from: data)
    ...
    func fetchNewsOtomodif() async {
        ...
        Task {
            do {
                let url = URL(string: "https://berita-indo-api-next.vercel.app/api/zetizen-jawapos-news/otomodif")!
                let (data, _) = try await URLSession.shared.data(from: url)
                let response = try JSONDecoder().decode(DataApi.self, from: data)
    ...
    func fetchNewsScience() async {
        ...
        Task {
            do {
                let url = URL(string: "https://berita-indo-api-next.vercel.app/api/zetizen-jawapos-news/science")!
                let (data, _) = try await URLSession.shared.data(from: url)
                let response = try JSONDecoder().decode(DataApi.self, from: data)
